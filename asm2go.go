...
func generatePlan9Assembly(goDeclarationFile string, outputFile string, syms map[string][]assembler.MachineInstruction) error {
...
func main() {
	...
	err = generatePlan9Assembly(*goFileOpt, *outputFile, symsToInstructions)
	if err != nil {
		fmt.Println(err)
		os.Exit(1)
	}
